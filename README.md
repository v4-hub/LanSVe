...
LanSVeg/
\n\n```\nLanSVeg/\n├── 01_get_vegetation_indices.py   # GEE script to extract VI data for multiple time windows.\n├── 02_get_landcover_data.py         # GEE script to extract land cover and forest data.\n├── 03_data_analysis_final.R         # R script for all statistical analysis and figure generation.\n|\n├── data/\n│   └── glc_merged_landslide_point.csv # The primary landslide point data used as input.\n│\n├── figures/                         # Contains all figures generated by the R script (e.g., Main_Figure_1.png).\n│\n├── tables/                          # Contains all tables and statistical outputs (e.g., Extended_Data_Table_1.csv).\n│\n└── README.md                        # This file.\n```\n\n---\n
